...
$$y_t = y_{t-1}A_1 + y_{t-2}A_2 + y_{t-3}A_3 + y_{t-4}A_4 + U_t$$
...
#THIS IS TEMPORARILY COMMENTED OUT, ADD ANOTHER ` BELOW TO RETURN TO CODE REMOVE ` to render
``{r}
...
#| code-fold: true
#| message: false
urate = urate %>% filter(urate$Date >= '1979 Q2')
urate = urate %>% filter(urate$Date < '2020 Q1')

mearn = mearn %>% filter(mearn$Date >= '1979 Q2')
mearn = mearn %>% filter(mearn$Date < '2020 Q1')

rgdpcap = rgdpcap %>% filter(rgdpcap$Date >= '1979 Q2')
rgdpcap = rgdpcap %>% filter(rgdpcap$Date < '2020 Q1')
...
CPI2 = CPI2 %>% filter(CPI2$Date >= '1979 Q2')
CPI = CPI2 %>% filter(CPI2$Date < '2020 Q1')

govex = govex %>% filter(govex$Date >= '1979 Q2')
govex = govex %>% filter(govex$Date < '2020 Q1')

M2 = M2 %>% filter(M2$Date >= '1979 Q2')
M2 = M2 %>% filter(M2$Date < '2020 Q1')
